...
save boot/outfile = indirect.sav/names = nms.
...
Print/title = "********************************* NOTES **********************************".
do if (btn = 1).
Print/title = "Bootstrap confidence intervals are preferred to normal theory tests for inference about indirect effects".
